...
int mamory_alocate_matrics_A(int **A,int rows_A, int colums_A);
int mamory_alocate_matrics_B(int **B,int rows_B, int colums_B);
int main()
{
    int **A;
    int **B;
    ...
    int E = 0;
     ...
     A = mamory_alocate_matrics_A(A,rows_A,colums_A);
     B = mamory_alocate_matrics_B(B,rows_B,colums_B);
